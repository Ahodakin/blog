      ...
      <div class="container">
        <div class="columns is-centered">
          <div class="column is-9-widescreen">
            <h1 class="mb-6">Bienvenue dans notre monde créatif et inspirant, <br>où chaque idée est un pas vers l'innovation.</h1>
            <div><img src="assets/images/xvertise-02.png" alt="reine" ></div>
          </div>
        </div>
      </div>
    ...
    <section class="section-sm">
      ...
      <div class="columns is-multiline is-desktop is-justify-content-center">       
        <div class="column is-8-desktop mb-5">
          <h2 class="h5 section-title">Post récent</h2>
