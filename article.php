<?php
    session_start();
    require("action/questions/showArticleAction.php");
    require("action/questions/postAnswerAction.php");
    require("action/questions/showAnswerOfQuestionAction.php");
?>
          ...
          <div class="content">
            ...
            <div class="input-group">
              <form action="" method="POST">
                ...
                <input type="text"  id="name" class="input"  name="answer"><br><br>
